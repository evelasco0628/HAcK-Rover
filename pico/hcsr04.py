from machine import Pin, timepulseus
from utime import sleepus

version = '0.2.1'
_author = 'Roberto Sánchez'
__license = "Apache License 2.0. https://www.apache.org/licenses/LICENSE-2.0"
...
class HCSR04:
    ...
    def init(self, trigger_pin, echo_pin, echo_timeout_us=500230):
        """
